...
var (
	// zippertbunnyRoles represents zipper t bunny roles.
	zippertbunnyRoles = []nook.Role{
		role.HolidayVisitor}
)

var (
	// zippertbunnyGames represents zippertbunny game appearances.
	zippertbunnyGames = []nook.Game{
		game.AmiiboFestival,
		game.CityFolk,
