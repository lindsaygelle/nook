...
var (
	// donresettiRoles represents don resetti roles.
	donresettiRoles = []nook.Role{
		role.RegularVisitor}
)

var (
	// donresettiGames represents donresetti game appearances.
	donresettiGames = []nook.Game{
		game.AmiiboFestival,
		game.AnimalCrossing,
		game.CityFolk,
