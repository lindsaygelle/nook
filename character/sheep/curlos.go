...
var (
	// curlosGames represents curlos game appearances.
	curlosGames = []nook.Game{
		game.AmiiboFestival,
...
var (
	// curlosBirthday represents Curlos's birthday.
...
var (
	// curlosCode represents Curlos's unique code.
