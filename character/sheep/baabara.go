...
var (
	// baabaraGames represents baabara game appearances.
	baabaraGames = []nook.Game{
		game.AmiiboFestival,
		game.AnimalCrossing,
		game.CityFolk,
		game.DongwuSenlin,
...
var (
	// baabaraBirthday represents Baabara's birthday.
...
var (
	// baabaraCode represents Baabara's unique code.
