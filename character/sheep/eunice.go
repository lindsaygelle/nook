...
var (
	// euniceGames represents eunice game appearances.
	euniceGames = []nook.Game{
		game.AmiiboFestival,
		game.AnimalCrossing,
		game.CityFolk,
		game.DongwuSenlin,
...
var (
	// euniceBirthday represents Eunice's birthday.
...
var (
	// euniceCode represents Eunice's unique code.
