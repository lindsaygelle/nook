...
var (
	// woolioGames represents woolio game appearances.
	woolioGames = []nook.Game{
		game.DoubutsuNoMori,
...
var (
	// woolioBirthday represents Woolio's birthday.
...
var (
	// woolioCode represents Woolio's unique code.
