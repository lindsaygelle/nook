...
var (
	// carolineGames represents caroline game appearances.
	carolineGames = []nook.Game{
...
var (
	// carolineBirthday represents Caroline's birthday.
...
var (
	// carolineCode represents Caroline's unique code.
