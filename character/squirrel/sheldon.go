...
var (
	// sheldonGames represents sheldon game appearances.
	sheldonGames = []nook.Game{
		game.NewLeaf,
		game.NewHorizons,
...
var (
	// sheldonBirthday represents Sheldon's birthday.
...
var (
	// sheldonCode represents Sheldon's unique code.
