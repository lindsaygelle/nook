...
var (
	// marshalGames represents marshal game appearances.
	marshalGames = []nook.Game{
		game.AmiiboFestival,
...
var (
	// marshalBirthday represents Marshal's birthday.
...
var (
	// marshalCode represents Marshal's unique code.
