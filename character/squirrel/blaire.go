...
var (
	// blaireGames represents blaire game appearances.
	blaireGames = []nook.Game{
		game.DoubutsuNoMori,
...
var (
	// blaireBirthday represents Blaire's birthday.
...
var (
	// blaireCode represents Blaire's unique code.
