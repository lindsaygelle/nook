...
var (
	// filbertGames represents filbert game appearances.
	filbertGames = []nook.Game{
		game.AmiiboFestival,
		game.AnimalCrossing,
		game.CityFolk,
		game.DongwuSenlin,
...
var (
	// filbertBirthday represents Filbert's birthday.
...
var (
	// filbertCode represents Filbert's unique code.
