...
var (
	// claudiaGames represents claudia game appearances.
	claudiaGames = []nook.Game{
		game.NewLeaf,
		game.NewHorizons,
...
var (
	// claudiaBirthday represents Claudia's birthday.
...
var (
	// claudiaCode represents Claudia's unique code.
