...
var (
	// rhondaGames represents rhonda game appearances.
	rhondaGames = []nook.Game{
		game.WildWorld,
		game.CityFolk,
		game.NewLeaf,
		game.NewHorizons,
...
var (
	// rhondaBirthday represents Rhonda's birthday.
...
var (
	// rhondaCode represents Rhonda's unique code.
