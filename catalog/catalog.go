...
import (
	...
	"github.com/lindsaygelle/nook/character/bear_cub"
	...
	"github.com/lindsaygelle/nook/character/frillnecked_lizard"
	"github.com/lindsaygelle/nook/character/frog"
	"github.com/lindsaygelle/nook/character/fur_seal"
...
var AllResidents = map[nook.Key]nook.Residents{
	...
	animal.Monkey.Key:            monkey.Residents,
	...
	animal.Rabbit.Key:            rabbit.Residents,
	...
	animal.Squirrel.Key:          squirrel.Residents,
...
// AllVillagers groups all villager collections by animal key.
var AllVillagers = map[nook.Key]nook.Villagers{
